\documentclass[a5paper,10pt,marginnote=raggedouter]{book}
...
Three major encodings are specified in the
...
\begin{description}
  \item[\acroshort{UTF}-32]\acroindex[!UTF-32@{\acroshort{UTF}-32}]{UTF}Directly%
    ...
    four-byte integers. This encoding is also known as
...
server. An example of centralized \acronym{VCS} is \acronym{SVN}\footnote{
  ...
  which is available in full at \url{http://svnbook.com/}.
}. By comparison,
