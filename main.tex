  ...
  \mainmatter
    ...
    \chapter{Markup}
      ...
      \subsection{The Semantic Web and Microdata}
        ...
        \acronym{RDF} document represents data as a set of triplets. Each of the
        ...
        % Write about PICS, POWDER and SPARQL?
          
          % Examples of Dublin Core
          % Examples of RDF usage and serialization (see wiki) + diagram
