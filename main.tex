...
\acronym{SGML}\footnote{
  ...
  includes the full text of the standard along with extensive annotations.
} \cite{iso86}.
...
expressive \acronym{SGML} feature of \inx{\identifier{CONCUR}}, which makes it
possible to mark up several structural views of a single document. Unlike with
