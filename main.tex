...
\begin{figure}
  ...
  \caption{\inx{Tortoise \acroshort{SVN}} is a graphical frontend for
    ...
    of a \inx{Microsoft Word} document even though it is not stored in a text
    file.}
\end{figure}
...
document. In book design, this involves the selection of one or several type
faces that are well-suited to both the document and each other, the design and
...
and the choice of the paper and type area geometry. In web design, several
visual systems may have to be created to accommodate for various devices.

\section{Typefaces}
\subsection{Terminology}
\subsection{History}
\subsection{Choosing a Typeface}
\section{Structural Element Design}
