...
\begin{figure}
  ...
  \caption{Exceptions that prove the rule about the separation of text and
    ...
    Morgenstern}'s \work{\foreign[german]{Trichter}}, where the text and its
...
concern.\iffalse\footnote{
  ...
  encodings.
}\fi``We had over sixty different ways to represent characters in
...
characters, control codes have no fixed visual representation or precise
semantics and were used to implement application-specific communication
