...
One of the archetypal batch-oriented systems are \inx{\texttt{troff}}, whose
function is to produce output for general printers, and \texttt{nroff}%
\index{\texttt{nroff}|seealso{\texttt{troff}}}, whose function is to produce
...
\acronym{ATnT}. An alternative to \texttt{nroff} and \texttt{troff} is
\texttt{groff}\index{\texttt{groff}|seealso{\texttt{troff}}}, which was
developed as a free software in 1980 by \acronym{GNU}. \texttt{Groff} combines
