    ...
    \chapter{Markup}
      ...
      \subsection{Batch-oriented Document Preparation Systems}
        ...
        industry standard for academic and technical typesetting.
          ...
          % Example of a plain TeX and LaTeX document

        % Batch-oriented
          % troff / groff / nroff / runoff, UNIX manpages
          % LaTeX
          % lout
          %%% The Text Processor for Typesetters <http://www.troff.org/>
          %%% <ftp://ftp.dante.de/tex-archive/support/tr2latex/diffs.tex>
          %%% <http://troff.org/TheGroffFriendsHowto.pdf>
          %%% TEX kontra Word
          %%%   <http://math.feld.cvut.cz/ftp/olsak/typo/texword.pdf>
        % WYSIWYG
