    ...
    \chapter{Markup}
      ...
      \subsection{The Extensible Markup Language}
        ...
        {\def\bottomfraction{0.7}\begin{figure}[hb]
          {\tikzstyle{level 1}=[sibling distance=\baselineskip, level distance=3.5cm]
          \begin{tikzpicture}[grow=right]
            \node {\textcolor{red}{Speech}}
              child {
                node[label=right:{AASE: See, you dare not! Every word of it's a lie!} ] {}}
              child {
...
<(\textcolor{blue}{V})line>Every word of it's a lie!</(\textcolor{red}{S})speech></(\textcolor{blue}{V})line>
        ...
        %%   <http://wayback.archive.org/web/20070624034347/http://www.sfb632.uni-potsdam.de/publications/isis02_4witt.pdf>
      ...
      \subsection{The Hypertext Markup Language}
        ...
        \begin{figure}
          ...
          \caption{An excerpt from the Web site of the \acronym{CSS} Zen Zarden
            ...
            logical markup and \acronym{CSS} style definitions.}\medskip
      ...
      \subsection{Batch-oriented Document Preparation Systems}
        ...
        technical typesetting.
          ...
          % Example of a plain TeX and a LaTeX document
      ...
      \section{Lightweight Markup Languages}
        ...
        conversion to more general markup languages, such as \acronym{HTML}.
