  ...
  \mainmatter
    ...
    \chapter{Markup}
      ...
      \subsection{The Extensible Markup Language}
        ...
        A notable new feature of \acronym{XML} are \emph{name spaces}, which
        ...
        schemata. That makes it impossible to validate namespaced \acronym{XML}
      ...
      \subsection{The Extensible Hypertext Markup Language}
        ...
        of \acronym{XML} name spaces. As a result, \acronym{XHTML} has yet to
