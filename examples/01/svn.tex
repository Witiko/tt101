...
\fsidenote{After a remote repository has been established, users download the
  latest version of the document and then \textcolor{\svncheckout}{keep
  downloading the latest changes by other users} and
