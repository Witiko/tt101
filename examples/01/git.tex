...
\caption{The basic Git workflow. After a remote repository has been
  created, users make local copies of the entire repository and then
  \textcolor{\gitcommit}{store changes in their local repositories} or
  \textcolor{\gitcheckout}{revert changes from their local repositories}. Users
  periodically \textcolor{\gitpull}{download the latest changes by other users}
  and \textcolor{\gitpush}{upload changes of their own}.}}
