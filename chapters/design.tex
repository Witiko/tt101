...
\begin{figure}
  \vspace{.5em}%
  \fbox{\includegraphics[clip,trim=4.3cm 21.6cm 3.8cm 4.55cm,%
...
Y,$ and $Z$) that specify a color.~\cite{cie32}\sidenote{%
  For an approachable introduction to the color theory, see \work{the
  Reproduction of Colour} by \citeauthor{hunt05}~\cite{hunt05}.
  For a dauntingly complete treatment of the art and science of color, see
  \citeauthor{gunther82}' \work{Color Science}~\cite{gunther82}.}
...
\begin{figure}
  ...
  \caption{A \acronym{CIE} $xyY$ chromacity diagram, where the shark-fin-shaped
    \protect\term{spectral locus} corresponds to a narrow-band \acronym{SPD}
