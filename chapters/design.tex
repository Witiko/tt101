...
\begin{figure}
  \fbox{\includegraphics[clip,trim=4.3cm 19.75cm 4.35cm 4.55cm,%
    width=0.975\textwidth]{examples/03/cornford12.pdf}}\vspace{.9em}
...
% An example of a nice and simple figure
% An example of a nice and simple list
...
\begin{enumerate}
  \item[1]\Termpl{sidenote} are displayed in the horizontal margins next to the
    \sidenote{%
      This is a sidenote. Sidenotes are ideal for short comments and are
      easy for the reader to find.}
